...
/** Represents the configuration for a data pipeline.
  ...
  * @param tag
  *   The tag associated with the data pipeline.
  * @param dataSources
  *   The list of data source configurations.
  * @param transformations
  *   The list of transformation configurations.
  * @param sinks
  *   The list of sink configurations.
  */
...
/** Represents the configuration for a data source.
  ...
  * @param query
  *   The query to be executed for the data source.
  * @param config
  *   A map of configuration properties for the data source.
  */
...
/** Represents the execution mode for a data pipeline.
  *
  * @param Read
  *   The data pipeline will read data from the data sources.
  */
object ExecutionMode extends Enumeration {
  ...
  /** Converts a string to an ExecutionMode.
    ...
    * @return
    */
  def fromString(s: String): ExecutionMode = s match {
    case "test"       => Test
    case "debug"      => Debug
    case "production" => Production
    case _            => throw new IllegalArgumentException(s"Invalid execution mode: $s")
  }
}
