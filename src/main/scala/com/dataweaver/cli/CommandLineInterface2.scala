...
//                val defaultRunner = project_config.getDefaultRunner
//                val runner_type: String = config.runner.getOrElse(defaultRunner)
//
...
//                        return
//                    }
//                    new RemoteSparkRunner(waver_jar_path, waver_cluster_url)
